...
define( 'TT_ROTEIROS_VERSION', '2.0.16' );
...
define( 'TT_VOUCHER_VERSAO_MODELOS', '2.0.11' );
...
require_once TT_ROTEIROS_DIR . 'includes/ajustes.php';
require_once TT_ROTEIROS_DIR . 'includes/opcoes.php';
